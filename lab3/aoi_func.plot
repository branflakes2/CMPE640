...
plot 'aoi_func.csv' using 7:8 with lines lt 1

set xtics format ''
set ylabel 'C' offset 1
set tmargin at screen TOP-3*DY
set bmargin at screen TOP-4*DY
plot 'aoi_func.csv' using 5:6 with lines lt 2

set ylabel 'B' offset 1
set tmargin at screen TOP-2*DY
set bmargin at screen TOP-3*DY
plot 'aoi_func.csv' using 3:4 with lines lt 3

set ylabel 'A' offset 1
set tmargin at screen TOP-DY
set bmargin at screen TOP-2*DY
plot 'aoi_func.csv' using 1:2 with lines lt 4

set title "AOI Extracted View Functionality Simulation"
set ylabel 'Out' offset 1
set tmargin at screen TOP
set bmargin at screen TOP-DY
plot 'aoi_func.csv' using 9:10 with lines lt 5
