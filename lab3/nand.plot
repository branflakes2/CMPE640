...
set title "Nand Simulation Plots"

plot \
'Output_nand_4_sA.csv' using 3:4 with lines lt 1 title "sA sch", \
'nand_sA.csv' using 1:2 with lines lt 1 dashtype 2 title "sA ext", \
'Output_nand_4_sB.csv' using 3:4 with lines lt 2 title "sB sch", \
'nand_sB.csv' using 1:2 with lines lt 2 dashtype 2 title "sB ext"
