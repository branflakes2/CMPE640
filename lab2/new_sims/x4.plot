...
plot \
'Output_x4_1.csv' using 3:4 with lines linestyle 1 title "1 Load Inverter", \
'Output_x4_2.csv' using 3:4 with lines linestyle 2 title "2 Load Inverters", \
'Output_x4_4.csv' using 3:4 with lines linestyle 3 title "4 Load Inverters", \
'Output_x4_8.csv' using 3:4 with lines linestyle 4 title "8 Load Inverters", \
'Output_x4_16.csv' using 3:4 with lines linestyle 5 title "16 Load Inverters"
