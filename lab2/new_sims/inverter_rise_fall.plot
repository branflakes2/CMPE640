...
set output 'inverter_rise_fall.tex'
...
set ylabel "Rise/Fall Times (sec)"
set xlabel "Number of X1 Load Inverters"
set title "Rise and Fall Times of Different Sized Inverters With Different Loads"

plot 'inverter_rise_fall_table.csv' using 2:xtic(1) title col, \
