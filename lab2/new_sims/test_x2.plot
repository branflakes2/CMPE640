...
plot \
'Output_x2_1.csv' using 1:2 with lines linestyle 1 title "1 Load Inverter", \
'Output_x2_2.csv' using 1:2 with lines linestyle 2 title "2 Load Inverters", \
'Output_x2_4.csv' using 1:2 with lines linestyle 3 title "4 Load Inverters", \
'Output_x2_8.csv' using 1:2 with lines linestyle 4 title "8 Load Inverters", \
'Output_x2_16.csv' using 1:2 with lines linestyle 5 title "16 Load Inverters"
